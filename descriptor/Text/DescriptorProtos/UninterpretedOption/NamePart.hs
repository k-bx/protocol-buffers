...
instance P'.ReflectDescriptor NamePart where
  reflectDescriptorInfo _
    = P'.read
        "DescriptorInfo {descName = ProtoName {protobufName = Utf8 {utf8 = Chunk \"MakeReflections.xxx\" Empty}, haskellPrefix = \"Text\", parentModule = \"DescriptorProtos.UninterpretedOption\", baseName = \"NamePart\"}, descFilePath = [\"Text\",\"DescriptorProtos\",\"UninterpretedOption\",\"NamePart.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoName {protobufName = Utf8 {utf8 = Chunk \"MakeReflections.xxx\" Empty}, haskellPrefix = \"Text\", parentModule = \"DescriptorProtos.UninterpretedOption.NamePart\", baseName = \"name_part\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, wireTagLength = 1, isRequired = True, canRepeat = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoName {protobufName = Utf8 {utf8 = Chunk \"MakeReflections.xxx\" Empty}, haskellPrefix = \"Text\", parentModule = \"DescriptorProtos.UninterpretedOption.NamePart\", baseName = \"is_extension\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, wireTagLength = 1, isRequired = True, canRepeat = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = True}"