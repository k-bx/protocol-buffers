...
instance P'.TextMsg MessageOptions where
  ...
  textGet
   = do
       mods <- P'.sepEndBy
                (P'.choice [parse'message_set_wire_format, parse'no_standard_descriptor_accessor, parse'uninterpreted_option])
                P'.spaces
