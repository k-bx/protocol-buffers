...
instance P'.Mergeable EnumValueOptions where
  mergeAppend (EnumValueOptions x'1 x'2 x'3 x'4) (EnumValueOptions y'1 y'2 y'3 y'4)
   = let !z'1 = P'.mergeAppend x'1 y'1
      ...
      in EnumValueOptions z'1 z'2 z'3 z'4
