...
instance P'.Mergeable UninterpretedOption where
  mergeEmpty
   = UninterpretedOption P'.mergeEmpty P'.mergeEmpty P'.mergeEmpty P'.mergeEmpty P'.mergeEmpty P'.mergeEmpty P'.mergeEmpty
      P'.mergeEmpty
    ...
    where
        update'Self wire'Tag old'Self
         = case wire'Tag of
             ...
             66 -> P'.fmap (\ new'Field -> old'Self{aggregate_value = P'.Just new'Field}) (P'.wireGet 9)
