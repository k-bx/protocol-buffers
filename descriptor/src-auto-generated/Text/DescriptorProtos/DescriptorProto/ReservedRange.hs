...
instance P'.Wire ReservedRange where
  ...
  wirePutWithSize ft' self'@(ReservedRange x'1 x'2 x'3)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
