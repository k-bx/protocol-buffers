...
instance P'.Wire EnumValueDescriptorProto where
  wireSize 11 (EnumValueDescriptorProto x'1 x'2 x'3) = (P'.wireSizeOpt 1 9 x'1 + P'.wireSizeOpt 1 5 x'2 + P'.wireSizeOpt 1 11 x'3)
