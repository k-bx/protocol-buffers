...
instance P'.Wire ServiceDescriptorProto where
  wireSize 11 (ServiceDescriptorProto x'1 x'2 x'3) = (P'.wireSizeOpt 1 9 x'1 + P'.wireSizeRep 1 11 x'2 + P'.wireSizeOpt 1 11 x'3)
