...
data TestDupFieldNumber = TestDupFieldNumber{a :: P'.Maybe P'.Int32, foo :: P'.Maybe UnittestProto.TestDupFieldNumber.Foo,
                                             bar :: P'.Maybe UnittestProto.TestDupFieldNumber.Bar}
                        deriving (P'.Show, P'.Eq, P'.Ord, P'.Typeable)
 
instance P'.Mergeable TestDupFieldNumber where
  mergeEmpty = TestDupFieldNumber P'.mergeEmpty P'.mergeEmpty P'.mergeEmpty
  mergeAppend (TestDupFieldNumber x'1 x'2 x'3) (TestDupFieldNumber y'1 y'2 y'3)
...
instance P'.Wire TestDupFieldNumber where
  wireSize ft' self'@(TestDupFieldNumber x'1 x'2 x'3)
    ...
    where
        calc'Size = (P'.wireSizeOpt 1 5 x'1 + P'.wireSizeOpt 1 10 x'2 + P'.wireSizeOpt 1 10 x'3)
  wirePut ft' self'@(TestDupFieldNumber x'1 x'2 x'3)
    = case ft' of
        10 -> put'Fields
        11
          -> do
